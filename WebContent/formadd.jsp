...
<body class="is-preload">
	...
	<div id="footer">
		<div class="container medium" id="contato">
					...
					<div class="row">
						...
						<script>
							...
							function validarEntrada(){
								console.log(document.getElementById("txtCodigo").value);
								var e = document.getElementById("txtCodigo");
								var entrada = e.options[e.selectedIndex].text;
								if (entrada != ""){
									alert("sucesso");
								}else{
									alert("erro");
						...
						<div class="col-12">
							<ul class="actions special">
								<button class="buttonGo" type="button" onclick="validarEntrada()" value="CADASTRAR">CADASTRAR</button>
								<li><input type="submit" value="CADASTRAR" id="operacao" name="operacao" onclick="validarEntrada()"/></li>
							</ul>
						</div>
					</div>
			</form>
			...
			<%
				Sala p = (Sala) resultado.getEntidades().get(i);
			%>

			<ul class="copyright">
				<li>&copy; Todos os direitos reservados</li>
				<li>CineMax</a></li>
				<li>aaaaaaaaaaa<%p.getCodigo()%></li>
			</ul>
